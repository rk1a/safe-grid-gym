...
setuptools.setup(
    ...
    install_requires=[
        "gym>=0.12",
        "ai-safety-gridworlds @ https://github.com/rk1a/ai-safety-gridworlds/tarball/master#egg=ai-safety-gridworlds-1.5",
        "numpy",
        "pillow",
        "matplotlib",
    ],
    dependency_links=[
        "https://github.com/rk1a/ai-safety-gridworlds/tarball/master#egg=ai-safety-gridworlds-1.5"
    ],
